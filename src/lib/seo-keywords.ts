...
export const CSV_SEO_KEYWORD_ENTRIES: ReadonlyArray<CsvKeywordEntry> = [
  { phrase: 'sim data', avgMonthlySearches: 500000 },
  ...
  { phrase: 'tracker sim', avgMonthlySearches: 50000 },
  ...
  { phrase: 'pakdata ml', avgMonthlySearches: 5000 },
  ...
  // Theme-specific additions from the same CSV file for better blog relevance.
  ...
  { phrase: 'ufone sim owner details', avgMonthlySearches: 500 },
...
const SEO_SURFACE_HINTS: Record<SeoSurface, string> = {
  ...
  apps:
    'online sim check live tracker sim data sim tracker online sim number check mobile number details',
  disclaimer:
    'sim details online cnic details online sim verification sim owner details check legal privacy',
  search:
